    ...
    return (
      <div>      
        <ul className="text-left">
          <li className="p-5"><FontAwesomeIcon icon={faCloud} className="mr-2" /><a href="https://cosma-design.com/" title="FPGA Desin Services" target="_blank">https://cosma-design.com/</a> is a responsive web site with Bootstrap css and css animations.</li>
