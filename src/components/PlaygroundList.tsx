    ...
    return (
      <div>      
        <ul className="text-left">
          <li className="p-5"><FontAwesomeIcon icon={faLaptopCode} className="mr-2" /><a href="https://julia-le.pages.dev/lp-furniture" title="https://julia-le.pages.dev/lp-furniture">/lp-furniture/</a> is a responsive landing page with css animations.</li>
